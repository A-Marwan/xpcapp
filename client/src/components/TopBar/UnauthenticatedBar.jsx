                ...
                <GridContainer className={classes.container}>
                    ...
                    <GridItem xs={12} sm={4}>
                        <GridContainer className={classes.buttons_container}>
                            ...
                            <GridItem xs={12} sm={5} component={Button} href={"/login"} simple variant="contained" color="info" link className={classes.appBar_button}><FormattedMessage id={"topBar.action.login"}/></GridItem>
                        </GridContainer>
                    </GridItem>
                </GridContainer>
            </AppBar>
