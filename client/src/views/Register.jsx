...
export default reduxForm({form: "login", enableReinitialize: true, keepDirtyOnReinitialize: true})(connect(mapStateToProps, mapDispatchToProps)(withStyles(loginStyle)(RegisterPage)));
